...
- [DairyComp COWFILE import](milchvieh-cowfile-import.md) — dynamic-offset binary parser; dict names may start with digits, widths up to ~230; dataset delete must clear cow_events
