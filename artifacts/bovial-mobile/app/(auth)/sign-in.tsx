  ...
  if (signIn.status === "needs_client_trust") {
    return (
      <View style={[s.container, { paddingTop: insets.top + 60, paddingBottom: insets.bottom + 20 }]}>
        <Text style={s.title}>Bestätigung</Text>
        <Text style={s.subtitle}>Prüfcode aus E-Mail eingeben</Text>
        <TextInput
          style={s.input}
          value={verifyCode}
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      ...
      >
        ...
        <Text style={s.subtitle}>Melde dich mit deiner E-Mail an</Text>
        ...
        <View style={s.footer}>
          ...
          <Link href="/sign-up">
            <Text style={s.linkText}>Registrieren</Text>
          </Link>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
