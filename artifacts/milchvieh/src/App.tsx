...
const clerkAppearance = {
  ...
  elements: {
    ...
    otpCodeField: "gap-2",
    alternativeMethodsBlockButton__emailLink: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm",
    alternativeMethodsBlockButton__phoneCode: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm",
    alternativeMethodsBlockButton__passkey: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm",
  },
};
