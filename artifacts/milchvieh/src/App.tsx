...
import { ReferenceAnalysesPage } from "@/pages/operator/reference-analyses";
...
const clerkAppearance = {
  ...
  elements: {
    ...
    alternativeMethodsBlockButton: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm !opacity-100",
    alternativeMethodsBlockButtonText: "font-semibold text-base text-[#202e29] !opacity-100",
    alternativeMethodsBlockButtonArrow: "text-[#202e29] !opacity-100",
    ...
    phoneNumberBlockButton: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm",
    phoneNumberBlockButtonText: "font-semibold text-base text-[#202e29]",
    phoneNumberBlockButtonArrow: "text-[#202e29]",
    passkeyBlockButton: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm",
    passkeyBlockButtonText: "font-semibold text-base text-[#202e29]",
    passkeyBlockButtonArrow: "text-[#202e29]",
    formResendCodeLink: "text-[#2b5242] hover:underline font-semibold text-sm",
    backLink: "text-[#2b5242] hover:underline font-semibold text-sm",
    backLinkArrow: "text-[#2b5242]",
    verificationLinkStatusBox: "border border-[#c8c3b8] bg-[#f7f5f0] rounded-lg p-4",
    verificationLinkStatusIconBox: "text-[#2b5242]",
    verificationLinkStatusText: "text-sm text-[#202e29]",
    verificationLinkStatusClipboardText: "text-sm text-[#4a5c54]",
    otpCodeField: "gap-2",
    alternativeMethodsBlockButton__emailLink: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm !opacity-100",
    alternativeMethodsBlockButton__emailCode: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm !opacity-100",
    alternativeMethodsBlockButton__phoneCode: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm !opacity-100",
    alternativeMethodsBlockButton__passkey: "border-2 border-[#c8c3b8] bg-white hover:bg-[#f7f5f0] text-[#202e29] h-11 rounded-lg shadow-sm !opacity-100",
  },
};
  ...
  return (
    ...
    >
      <Switch>
        ...
        <Route path="/app/reference-analyses" component={ReferenceAnalysesPage} />
